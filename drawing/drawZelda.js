function drawZelda(type, frame, x, y) {
    ctx.save();
...
function drawFace3() {
    ctx.fillStyle = "#93CE42"
    ctx.fillRect(6 * UNIT, 1 * UNIT, 3 * UNIT, 2 * UNIT)
    ctx.fillRect(6 * UNIT, 3 * UNIT, 2 * UNIT, 1 * UNIT)
    ctx.fillRect(9 * UNIT, 1 * UNIT, 1 * UNIT, 1 * UNIT)
    ctx.fillRect(4 * UNIT, 2 * UNIT, 2 * UNIT, 1 * UNIT)
    ctx.fillRect(3 * UNIT, 3 * UNIT, 2 * UNIT, 3 * UNIT)
    ctx.fillRect(2 * UNIT, 5 * UNIT, 2 * UNIT, 2 * UNIT)
    ctx.fillRect(1 * UNIT, 6 * UNIT, 1 * UNIT, 2 * UNIT)
    ctx.fillRect(11 * UNIT, 5 * UNIT, 1 * UNIT, 1 * UNIT)
    ctx.fillStyle = "#EF9C4E"
    ctx.fillRect(5 * UNIT, 4 * UNIT, 2 * UNIT, 2 * UNIT)
    ctx.fillRect(5 * UNIT, 3 * UNIT, 1 * UNIT, 1 * UNIT)
    ctx.fillRect(6 * UNIT, 5 * UNIT, 2 * UNIT, 2 * UNIT)
    ctx.fillRect(7 * UNIT, 7 * UNIT, 2 * UNIT, 1 * UNIT)
    ctx.fillRect(9 * UNIT, 5 * UNIT, 2 * UNIT, 4 * UNIT)
    ctx.fillRect(11 * UNIT, 7 * UNIT, 2 * UNIT, 4 * UNIT)
    ctx.fillRect(13 * UNIT, 8 * UNIT, 1 * UNIT, 2 * UNIT)
    ctx.fillRect(13 * UNIT, 6 * UNIT, 2 * UNIT, 1 * UNIT)
    ctx.fillRect(12 * UNIT, 5 * UNIT, 1 * UNIT, 2 * UNIT)
    ctx.fillStyle = "#BA5425"
    ctx.fillRect(9 * UNIT, 2 * UNIT, 4 * UNIT, 3 * UNIT)
    ctx.fillRect(12 * UNIT, 3 * UNIT, 1 * UNIT, 1 * UNIT)
    ctx.fillRect(8 * UNIT, 3 * UNIT, 1 * UNIT, 4 * UNIT)
    ctx.fillRect(7 * UNIT, 4 * UNIT, 1 * UNIT, 1 * UNIT)
    ctx.fillRect(4 * UNIT, 6 * UNIT, 2 * UNIT, 2 * UNIT)
    ctx.fillRect(6 * UNIT, 7 * UNIT, 1 * UNIT, 1 * UNIT)
    ctx.fillRect(11 * UNIT, 6 * UNIT, 1 * UNIT, 1 * UNIT)
}
function drawClothes3() {
    ctx.fillStyle = "#93CE42"
    ctx.fillRect(4* UNIT,8* UNIT,5* UNIT,1* UNIT)
    ctx.fillRect(3* UNIT,9* UNIT,2* UNIT,1* UNIT)
    ctx.fillRect(3* UNIT,10* UNIT,1* UNIT,1* UNIT)
    ctx.fillRect(2* UNIT,11* UNIT,2* UNIT,3* UNIT)
    ctx.fillRect(1* UNIT,12* UNIT,1* UNIT,1* UNIT)
    ctx.fillRect(2* UNIT,12* UNIT,3* UNIT,2* UNIT)
    ctx.fillRect(3* UNIT,13* UNIT,5* UNIT,2* UNIT)
    ...
    ctx.fillStyle = "#BA5425"
    ctx.fillRect(5 * UNIT, 9 * UNIT, 6 * UNIT, 3 * UNIT)
...
function drawFeet3() {
    ...
    ctx.fillRect(1* UNIT,14* UNIT,2* UNIT,2* UNIT)
    ctx.fillRect(3* UNIT,15* UNIT,1* UNIT,1* UNIT)
    ctx.fillRect(12* UNIT,14* UNIT,2* UNIT,2* UNIT)
    ctx.fillRect(11* UNIT,15* UNIT,4* UNIT,1* UNIT)
}